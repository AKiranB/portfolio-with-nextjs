const projectData = [
  {
    ...
    img: "/weeve.png",
    description:
      "weeve is an “Integration Platform as a Service” that bridges the gap between the complexity of Internet of Things (IoT) and the demands of today’s Data Driven Business Systems.",
  ...
  },
  {
    ...
    githubUrl: "https://github.com/AKiranB/Fruits-Bats",
  },
  {
    title: "NextJS Portfolio",
    img: "/portfolio.png",
    description:
      "My Portfolio website, built using NextJS with Chakra UI as the component library. I additionally used Nodemailer to enable visitors to email me directly. The project also includes some basic unit testing with Jest. Pssst, If you haven't already noticed, you are looking at it right now!",
    appUrl: "https://kiran-boyle.vercel.app/",
    githubUrl: "https://github.com/AKiranB/portfolio-with-nextjs",
  },
];
