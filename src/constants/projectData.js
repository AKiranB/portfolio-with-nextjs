const projectData = [
    {
        title: 'Archimidi',
        img: '/archimidi.png',
        description: 'Archimidi is a Full Stack, MERN MIDI database website, where users can upload, favourite, download and preview midi files. Archimidi is a Full Stack, MERN MIDI database website',
