import { Box, Flex, Badge, Heading, Wrap, WrapItem, Container, Center } from "@chakra-ui/react";
                ...
                >
                    <Flex mb={"40px"} pl={"30px"} flexDirection={"column"}>
                        ...
                        <Box padding={0} fontSize={["sm", "md", "lg"]}>
                            ...
                            consumer of knowledge, who enjoys the challenges of problem-solving
                            both individually and in a team. I've recently completed a Fullstack
                            web development Bootcamp during which I built a solid foundation in
                            Javascript(ES6+), HTML5 and CSS3, front-end frameworks like React,
                            Node and Express. I've since expanded my skills through building new{" "}
                            <a href="#projects">
                                <u>projects</u>{" "}
                            </a>
